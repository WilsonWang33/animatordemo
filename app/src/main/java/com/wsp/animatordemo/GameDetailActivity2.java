...
public class GameDetailActivity2 extends AppCompatActivity {
    ActivityGameDetail2Binding layout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout = ActivityGameDetail2Binding.inflate(getLayoutInflater());
    ...
    private void initRecycler() {
        ...
        layout.recycler.setAdapter(new BaseRecyclerViewAdapter<String, SampleTVHolder>(strings,this) {
            ...
            public SampleTVHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                TextView tv = new TextView(GameDetailActivity2.this);
    ...
    class NewBannerAdapter<String> extends BannerAdapter<String,NewBannerHolder>{
        ...
        public NewBannerHolder onCreateHolder(ViewGroup parent, int viewType) {
            RelativeLayout relativeLayout = new RelativeLayout(GameDetailActivity2.this);
            ...
            ImageView imageView = new ImageView(GameDetailActivity2.this);
